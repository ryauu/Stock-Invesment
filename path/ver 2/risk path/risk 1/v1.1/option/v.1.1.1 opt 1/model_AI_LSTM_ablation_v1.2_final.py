...
Kết luận:Việc điều tra kỹ thuật (đo lường MDD, phí, DSR) đến đây có thể coi là
 ...
 Câu hỏi còn lại không còn thuộc phạm vi "tìm bug" nữa, 
 mà là câu hỏi thực chất của dự án: với số liệu đã sạch, risk management V2 
 (ở bất kỳ biến thể ngưỡng nào đã thử) không đủ sức đưa model V1 đạt ngưỡng DSR 
 pre-registered. Đây là kết luận nên được ghi nhận chính thức vào provenance của 
 dự án, thay vì tiếp tục dò thêm biến thể ngưỡng CB mới — vì bằng chứng đã đủ 
 nhất quán qua nhiều mức thử (-30%, -35%, -40%) rằng nút thắt nằm ở khả năng dự 
 đoán của model, không nằm ở lớp quản trị rủi ro.
"""
